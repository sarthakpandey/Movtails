...
public class TVShowSeeMoreCustomAdapter extends RecyclerView.Adapter<TVShowSeeMoreCustomAdapter.ViewHolderPro> {

    Context mContext;
    ArrayList<TVShowResponseGeneral> mTVShows;

    public TVShowSeeMoreCustomAdapter(Context mContext, ArrayList<TVShowResponseGeneral> mTVShows) {
    ...
    public ViewHolderPro onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolderPro(LayoutInflater.from(mContext).inflate(R.layout.tv_show_see_more_adapter_layout,parent,false));
    }
    ...
    public void onBindViewHolder(final ViewHolderPro holder, int position) {
        ...
        Glide.with(mContext).load(Constants.IMAGE_LOADING_BASE_URL_342 + tvshow.getBackdrop_path())
                .asBitmap()
                .centerCrop()
