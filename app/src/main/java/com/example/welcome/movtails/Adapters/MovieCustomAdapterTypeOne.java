...
public class MovieCustomAdapterTypeOne extends RecyclerView.Adapter<MovieCustomAdapterTypeOne.ViewHolderPro> {

    private Context mContext;
    private ArrayList<MovieResponseGeneral> mMovies;

    public MovieCustomAdapterTypeOne(Context mContext, ArrayList<MovieResponseGeneral> mMovies) {
    ...
    public ViewHolderPro onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolderPro(LayoutInflater.from(mContext).inflate(R.layout.adapter_one_layout,parent,false));
    }
