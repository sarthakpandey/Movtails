...
public class TVShowCustomAdapterTypeOne extends RecyclerView.Adapter<TVShowCustomAdapterTypeOne.ViewHolderPro> {

    Context mContext;
    ArrayList<TVShowResponseGeneral> mTVShows;

    public TVShowCustomAdapterTypeOne(Context mContext, ArrayList<TVShowResponseGeneral> mTVShows) {
    ...
    public ViewHolderPro onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolderPro(LayoutInflater.from(mContext).inflate(R.layout.adapter_one_layout_next,parent,false));
    }
    ...
    public void onBindViewHolder(final ViewHolderPro holder, int position) {
        ...
        Glide.with(mContext).load(Constants.IMAGE_LOADING_BASE_URL_342 + tvshow.getPoster_path())
                .asBitmap()
                .centerCrop()
    ...
    public class ViewHolderPro extends RecyclerView.ViewHolder{
        ...
        public ViewHolderPro(View itemView) {
            ...
            relativeLayout.getLayoutParams().width = (int)(mContext.getResources().getDisplayMetrics().widthPixels * 0.391);
            relativeLayout.getLayoutParams().height = (int)((mContext.getResources().getDisplayMetrics().widthPixels * 0.391) / 0.66);
