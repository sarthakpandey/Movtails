...
public class TVShowCustomAdapterTypeThree extends RecyclerView.Adapter<TVShowCustomAdapterTypeThree.ViewHolderPro> {

    Context mContext;
    ArrayList<TVShowResponseGeneral> mTVShows;

    public TVShowCustomAdapterTypeThree(Context mContext, ArrayList<TVShowResponseGeneral> mTVShows) {
    ...
    public ViewHolderPro onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolderPro(LayoutInflater.from(mContext).inflate(R.layout.adapter_three_layout_next,parent,false));
    }
...
//            holder.genreTextView.setText("");
    ...
    public class ViewHolderPro extends RecyclerView.ViewHolder{
        ...
        public ViewHolderPro(View itemView) {
            ...
            relativeLayout.getLayoutParams().height = (int)((mContext.getResources().getDisplayMetrics().widthPixels * 0.3125) / 0.66);
